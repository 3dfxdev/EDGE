...
typedef struct  // dynamic info
{
	bool modified;
	// true if this thing was modified, including any states or sounds
	// which are used by this thing.
}
mobjdyn_t;

extern mobjdyn_t mobj_dyn[NUMMOBJTYPES];
...
extern actioninfo_t action_info[NUMACTIONS];
