...
static int sample_count, current_sample;
...
{
	// returns true if OK, false for end-of-track
	
	for (; current_event->time <= current_sample; current_event++)
	{
...
void Timidity_FreeSong(struct MidiSong *song)
{
