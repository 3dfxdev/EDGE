...
//
// bool win32_filesystem_c::IsAbsolutePath()
//
bool win32_filesystem_c::IsAbsolutePath(const char *path)
{
...
//
// string_c win32_filesystem_c::JoinPath()
//
string_c win32_filesystem_c::JoinPath(const char *lhs, const char *rhs)
{
    epi::string_c s;
