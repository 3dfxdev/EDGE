...
static const commandlist_t finale_commands[] =
{
    ...
    DF("TEXT_GRAPHIC", text_back, DDF_MainGetInlineStr10),
    DF("TEXT_FLAT", text_flat, DDF_MainGetInlineStr10),
...
static const commandlist_t level_commands[] =
{
	...
	DF("SKY_TEXTURE", sky, DDF_MainGetInlineStr10),
	DF("MUSIC_ENTRY", music, DDF_MainGetNumeric),
	DF("SURROUND_FLAT", surround, DDF_MainGetInlineStr10),
	DF("NEXT_MAP", nextmapname, DDF_MainGetInlineStr10),
	DF("SECRET_MAP", secretmapname, DDF_MainGetInlineStr10),
