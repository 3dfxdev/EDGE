...
static bool heretic_mode = false;
...
std::string cfgfile;
std::string ewadfile;
std::string hwadfile; //herfix.wad!
...
{
		//int lump = W_CheckNumForName("LOADING");

		//I_Printf("InitDirectories: Heretic_mode = false")
	...
	{
		if (heretic_mode) //found Heretic, load HDF
		{
		 ///I_Printf("Found Heretic DDF Directory, init.");
...
const char *wadname[] = { "heretic", "doom2", "doom", "freedoom1", "freedoom2", "plutonia", "tnt", "hacx", "freedoom", "freedm", "chex.wad",  NULL };
