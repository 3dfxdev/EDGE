...
static void NET_CL_PlayerQuitGame(player_t *player)
{
    ...
    players[consoleplayer1].message = exitmsg;
...
static void NET_CL_Disconnected(void)
{
    ...
    players[consoleplayer1].message = "Disconnected from server";
...
static void NET_CL_ExpandFullTiccmd(net_full_ticcmd_t *cmd, unsigned int seq)
{
    ...
    if (latency >= 0)
    {
        ...
        else
        {
            ...
            average_latency = (float)((average_latency * 0.9)
...
extern std::string m_playername;
