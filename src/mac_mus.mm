...
abstract_music_c * I_PlayHWMusic(const byte *data, 
                                 int length, 
                                 float volume, 
                                 bool loop)
{
	...
	I_Printf("I_PlayHWMusic: Converting MUS format to MIDI...\n");
    ...
    std::string fn = epi::PATH_Join(cache_dir.c_str(), TMP_MIDI_NAME);
