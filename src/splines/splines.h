...
public:
	...
	bool getCameraInfo(long time, idVec3_t &origin, idVec3_t &direction, idVec3_t target, float *fv);
...
protected:
	...
	idVec3_t lastDirection, trackedPosition;
	bool cameraRunning;
...
struct idCameraTrigger : public idTriggerDef {
	idCameraTrigger(idTriggerDef &t);
	idCameraTrigger();
	~idCameraTrigger();

	int FirstCam, SecondCam;
