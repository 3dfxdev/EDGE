...
#define CFGDEF_KEY_FIRE         (KEYD_CTRL + (KEYD_MOUSE1 << 16))
#define CFGDEF_KEY_SECONDATK    ('e')
#define CFGDEF_KEY_USE          (KEYD_SPACE)
#define CFGDEF_KEY_UP           (KEYD_UPARROW + ('/' << 16))
...
#define CFGDEF_KEY_SPEED        (KEYD_SHIFT)
#define CFGDEF_KEY_STRAFE       (KEYD_ALT + (KEYD_MOUSE3 << 16))
