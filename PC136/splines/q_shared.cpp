...
void Com_InitGrowList( growList_t *list, int maxElements ) {
	...
	//(void **)Com_Allocate( list->maxElements * sizeof( void * ) );
}
...
extern short	BigShort(short l);/*{return _BigShort(l);}*/
extern short	LittleShort(short l);/* {return _LittleShort(l);}*/
extern int		BigLong (int l);/* {return _BigLong(l);}*/
extern int		LittleLong (int l);/* {return _LittleLong(l);}*/
extern float	BigFloat (float l);/* {return _BigFloat(l);}*/
extern float	LittleFloat (float l);/* {return _LittleFloat(l);}*/
